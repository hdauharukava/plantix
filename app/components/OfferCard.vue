<template>
  <div class="bg-white w-full h-full relative transition-all duration-300 hover:shadow-lg hover:scale-105">
    <div 
      v-if="discount" 
    ...
    <div class="px-2">
      ...
      <h3 class="font-poppins font-bold text-lg text-[#1e1e1e] mb-2">{{ title }}</h3>
...
const formattedOldPrice = computed(() => props.oldPrice ? `${props.oldPrice.toFixed(2)} zł` : '')
</script>