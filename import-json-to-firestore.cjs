...
// serviceAccountKey.json лежит рядом со скриптом (в руте)
const SA_PATH = path.join(BASE_DIR, "serviceAccountKey.json");

// JSON лежат в app/data
const PLANTS_JSON_PATH = path.join(BASE_DIR, "app", "data", "plants.json");
const ADVICE_JSON_PATH = path.join(BASE_DIR, "app", "data", "advice.json");
